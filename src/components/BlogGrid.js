                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="blog-post">
                                        ...
                                        <div className="down-content">
                                            ...
                                            <p>
                                                Nullam nibh mi, tincidunt sed
                                                sapien ut, rutrum hendrerit
                                                velit. Integer auctor a mauris
                                                sit amet eleifend.
                                            </p>
                                ...
                                <div className="col-lg-6">
                                    <div className="blog-post">
                                        <div className="blog-thumb">
                                            <img
                                                src="assets/images/blog-thumb-02.jpg"
                                                alt=""
                                            />
                                        </div>
                                        <div className="down-content">
                                ...
                                <div className="col-lg-6">
                                    <div className="blog-post">
                                        <div className="blog-thumb">
                                            <img
                                                src="assets/images/blog-thumb-03.jpg"
                                                alt=""
                                            />
                                        </div>
                                        <div className="down-content">
                                ...
                                <div className="col-lg-6">
                                    <div className="blog-post">
                                        <div className="blog-thumb">
                                            <img
                                                src="assets/images/blog-thumb-04.jpg"
                                                alt=""
                                            />
                                        </div>
                                        <div className="down-content">
                                ...
                                <div className="col-lg-6">
                                    <div className="blog-post">
                                        <div className="blog-thumb">
                                            <img
                                                src="assets/images/blog-thumb-05.jpg"
                                                alt=""
                                            />
                                        </div>
                                        <div className="down-content">
                                ...
                                <div className="col-lg-6">
                                    <div className="blog-post">
                                        <div className="blog-thumb">
                                            <img
                                                src="assets/images/blog-thumb-06.jpg"
                                                alt=""
                                            />
                                        </div>
                                        <div className="down-content">
